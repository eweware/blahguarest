...
class pxssh (spawn):
    ...
    def login (self,server,username,password='',terminal_type='ansi',original_prompt=r"[#$]",login_timeout=10,port=None,auto_prompt_reset=True,keypair_pathname=None):

        ### Ruben: added ec2 keypair pathname option
        ...
        ssh_options = '-q'
        if keypair_pathname != None:
            ssh_options += ' -i '+keypair_pathname
